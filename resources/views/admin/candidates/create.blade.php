...
<head>
    ...
    <title>Tambah Kandidat - E-Voting IPM</title>
...
<body class="bg-gray-100">
        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-blue-100">Tambah Kandidat Baru</p>
                </div>
            </div>
    ...
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="mb-8 fade-in">
            ...
            <p class="text-gray-600 mt-1">Isi form berikut untuk menambahkan kandidat baru</p>
        </div>
        <!-- Form -->
                    ...
                    <div>
                        ...
                        <div class="mb-5">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                <i class="fas fa-image mr-2 text-blue-600"></i>Pratinjau Foto
                            </label>
                            <div
                                class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center photo-preview-container transition">
                                <img id="photo-preview"
                                    class="mx-auto h-32 w-32 object-cover rounded-lg hidden mb-2 transition">
                                <div id="no-photo"
                                ...
                                <p class="text-sm text-gray-500 mt-2">Pratinjau foto akan muncul di sini</p>
                            </div>
                        </div>
                    </div>
                    <!-- Right Column -->
                    <div>
                        <div class="mb-5">
                            ...
                            <textarea id="vision" name="vision" rows="5"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none form-input transition"
                                placeholder="Tuliskan visi kandidat" required>{{ old('vision') }}</textarea>
                            @error('vision')
                                <p class="text-red-500 text-xs mt-1"><i
                                        class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-5">
                            ...
                            <textarea id="mission" name="mission" rows="5"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none form-input transition"
                                placeholder="Tuliskan misi kandidat" required>{{ old('mission') }}</textarea>
                            @error('mission')
                                <p class="text-red-500 text-xs mt-1"><i
                                        class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                            @enderror
    ...
    <script>
        // Photo preview with smooth transition
